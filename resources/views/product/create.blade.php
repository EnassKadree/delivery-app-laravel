        ...
        <div class="container">
            ...
            <div class="row">
                <div class="offset-md-3 col-md-6">
                    <form class="yourform" action="{{ route('admin.product.store') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name.en') is-invalid @enderror"
                                placeholder="Product Name in English" name="name[en]" value="{{ old('name.en') }}" required>
                            @error('name.en')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name.ar') is-invalid @enderror"
                                placeholder="Product Name in Arabic" name="name[ar]" value="{{ old('name.ar') }}" required>
                            @error('name.ar')
                                <div class="alert alert-danger" role="alert">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description.en') is-invalid @enderror"
                                placeholder="Product Description in English" name="description[en]" required>{{ old('description.en') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description.ar') is-invalid @enderror"
                                placeholder="Product Description in Arabic" name="description[ar]" required>{{ old('description.ar') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('price') is-invalid @enderror"
                                placeholder="Product Price" name="price" value="{{ old('price') }}" step="0.01" required>
                            @error('price')
                                <div class="alert alert-danger" role="alert">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('stock') is-invalid @enderror"
                                placeholder="Stock Quantity" name="stock" value="{{ old('stock') }}" required>
                            @error('stock')
                                <div class="alert alert-danger" role="alert">
                                    {{ $message }}
                                </div>
                            ...
                            <select class="form-control @error('store_id') is-invalid @enderror" name="store_id" id="store_id" required>
                                ...
                                @foreach ($stores as $store)
                                    <option value="{{ $store->id }}" {{ old('store_id') == $store->id ? 'selected' : '' }}>
                                        {{ $store->getTranslation('name', 'en') ?? 'N/A' }}
                                    </option>
                                @endforeach
                            </select>
                            @error('store_id')
